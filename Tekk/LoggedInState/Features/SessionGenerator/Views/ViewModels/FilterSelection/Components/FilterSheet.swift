                            ...
                            HStack {
                                ...
                                ZStack {
                                    RoundedRectangle(cornerRadius: 4)
                                        .fill(isSelected(option) ? globalSettings.primaryYellowColor : Color.clear)
                                        .stroke(isSelected(option) ? globalSettings.primaryYellowColor : globalSettings.primaryGrayColor, lineWidth: 1)
